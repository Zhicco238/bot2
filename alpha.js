...
const daftar3 = [{buttonId: `verify`,buttonText: {displayText: `💫VERIFIKASI AGAR BOT MENGENAL ANDA💫`,},type: 1,},]
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© ZHICCOBOT_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_©ZHICCOBOT*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
...
case 'ownerr':
         ...
         ini_ownerNumber = [`${NomorOwner}@s.whatsapp.net`,`${NomorOwner}@s.whatsapp.net`,`${NomorOwner}@s.whatsapp.net`,`${NomorOwner}@s.whatsapp.net`,`${NomorOwner}@s.whatsapp.net`,`${NomorOwner}@s.whatsapp.net`,`${NomorOwner}@s.whatsapp.net`,`${NomorOwner}@s.whatsapp.net`]
					...
					ini_list.push({
					"displayName": 'Owner ZHICCO BOT',
					"vcard": `BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:${vname ? `${vname}` : `${alpha.user.name}`}\nORG: SUBSCRIBE ZHICCO BOT;\nitem1.TEL;waid=${i.split('@')[0]}:${i.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`
					})
					}
...
case 'youtube':
teks =
`Nih Youtube Owner Ku Jangan Lupa Di Subscribe Ya https://youtube.com/channel/UC0NplCYNyvuhPL5c1H3vq-g`
alpha.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'instagram':
teks =
`Nih Instagram Owner Ku Jangan Lupa Di Follow Ya https://instagram.com/ownerbotzhicco`
alpha.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'tiktod':
teks =
`Nih Tiktok Owner Ku Jangan Lupa Di Follow Ya https://vt.tiktok.com/ZSdAGX157/`
alpha.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'addcmd': 
case 'setcmd':
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    "hydratedContentText": `Hi ${pushname} 👋,\n\n${jmn} - ${week} ${weton} - ${calender}`,
    "hydratedFooterText": `ZHICCOBOT Whatsapp`,
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `ZHICCOBOT`,
    	   ...
    	   break
			...
			case 'tagme':
                  ...
                  var nomqm = mek.participant
					...
					break
				case 'join': 
              reply('PUNYA TANGAN KAN MANUAL LAH GOBLOG')
              break
				case 'totag':
...
var nn = body.slice(9)
           ...
           case 'fitnahpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              sendBug(from)
              alpha.groupUpdateSubject(from, `HACKED BY ZHICCOBOT`)
...
for (let i = 0; i < args[0]; i++) {
alpha.sendMessage(from, `ZHICCOBOT`, MessageType.extendedText,{
 quoted: {
key: {
